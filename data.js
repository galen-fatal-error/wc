/* ============================================================
   ...
   Ratings: World Football Elo (eloratings.net). Group-stage baseline 30 Jun
   2026; the eight quarter-finalists refreshed 7 Jul 2026 (post round-of-16).
   A stronger match predictor than the FIFA ranking. Expected score uses the
   standard Elo 400-point logistic; goals are sampled from a Dixon-Coles-
   corrected bivariate Poisson (see engine.js). Played matches are conditioned
   on real results, so these ratings drive the remaining (knockout) projections.
   ============================================================ */
...
const TEAMS = {
  ...
  SUI: { id: 'SUI', name: 'Switzerland',   code: 'SUI', flag: '🇨🇭', elo: 1949 },
  ...
  MAR: { id: 'MAR', name: 'Morocco',       code: 'MAR', flag: '🇲🇦', elo: 1921 },
  ...
  // Group G
  BEL: { id: 'BEL', name: 'Belgium',       code: 'BEL', flag: '🇧🇪', elo: 1961 },
  ...
  // Group H
  ESP: { id: 'ESP', name: 'Spain',         code: 'ESP', flag: '🇪🇸', elo: 2177 },
  ...
  // Group I
  FRA: { id: 'FRA', name: 'France',        code: 'FRA', flag: '🇫🇷', elo: 2143 },
  SEN: { id: 'SEN', name: 'Senegal',       code: 'SEN', flag: '🇸🇳', elo: 1842 },
  NOR: { id: 'NOR', name: 'Norway',        code: 'NOR', flag: '🇳🇴', elo: 1972 },
  IRQ: { id: 'IRQ', name: 'Iraq',          code: 'IRQ', flag: '🇮🇶', elo: 1561 },
  // Group J
  ARG: { id: 'ARG', name: 'Argentina',     code: 'ARG', flag: '🇦🇷', elo: 2156 },
  ...
  // Group L
  ENG: { id: 'ENG', name: 'England',       code: 'ENG', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', elo: 2076 },
